...
echo '<script>alert("Your Academics has been updated")</script>';
}
...
Completed <?php echo htmlentities($result->Highets_School_level_Education);?>  with subjects <?php echo htmlentities($result->Subjects);?> from <?php echo  htmlentities($result->School_Name);?>. Currently pursuing <?php echo htmlentities($result->Course_Name); ?>  in <?php echo htmlentities($result->Stream);  ?> from <?php echo htmlentities($result->College_Name); ?> with specialization in <?php echo htmlentities($result->Specialization); ?>.
</div>
