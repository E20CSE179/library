...
<br><?php echo htmlentities("For any work on projects especially in the field of Artificial Intelligence and Machine Learning with ".htmlentities($result->Academic_Skills)." programming language contact on the below email.");?>
</div>
